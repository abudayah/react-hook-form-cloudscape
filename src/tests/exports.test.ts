...
describe("Package Exports Validation", () => {
  ...
  // Check if build exists, skip entire suite if not
  const buildExists = existsSync(resolve(projectRoot, "index.js"));

  describe.skipIf(!buildExists)("Built Package Structure", () => {
