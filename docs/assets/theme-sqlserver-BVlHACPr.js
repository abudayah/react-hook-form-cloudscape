import{g as A}from"./index-B8mIOO1f.js";function i(a,s){for(var r=0;r<s.length;r++){const e=s[r];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in a)){const c=Object.getOwnPropertyDescriptor(e,n);c&&Object.defineProperty(a,n,c.get?c:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var o={exports:{}},l;function v(){return l||(l=1,function(a,s){ace.define("ace/theme/sqlserver-css",["require","exports","module"],function(r,e,n){n.exports=`.ace-sqlserver .ace_gutter {
    background: #ebebeb;
    color: #333;
    overflow: hidden;
}
