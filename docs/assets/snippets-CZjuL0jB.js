...
snippet v
	{VISUAL}
`}),ace.define("ace/snippets/snippets",["require","exports","module","ace/snippets/snippets.snippets"],function(t,e,p){e.snippetText=t("./snippets.snippets"),e.scope="snippets"}),function(){ace.require(["ace/snippets/snippets"],function(t){s&&(s.exports=t)})}()}(i)),i.exports}var c=f();const g=u(c),l=a({__proto__:null,default:g},[c]);export{l as s};
