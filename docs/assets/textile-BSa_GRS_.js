import{g as a}from"./index-I3dhZJQA.js";function u(r,i){for(var t=0;t<i.length;t++){const e=i[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in r)){const o=Object.getOwnPropertyDescriptor(e,n);o&&Object.defineProperty(r,n,o.get?o:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}var p={exports:{}},s;function c(){return s||(s=1,function(r,i){ace.define("ace/snippets/textile.snippets",["require","exports","module"],function(t,e,n){n.exports=`# Jekyll post header
snippet header
	---
	title: \${1:title}
	layout: post
