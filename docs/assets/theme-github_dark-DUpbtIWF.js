import{g as d}from"./index-B8mIOO1f.js";function g(c,t){for(var a=0;a<t.length;a++){const e=t[a];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in c)){const r=Object.getOwnPropertyDescriptor(e,n);r&&Object.defineProperty(c,n,r.get?r:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(c,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},o;function b(){return o||(o=1,function(c,t){ace.define("ace/theme/github_dark-css",["require","exports","module"],function(a,e,n){n.exports=`.ace-github-dark .ace_gutter {
  background: #24292e;
  color: #7388b5
}
