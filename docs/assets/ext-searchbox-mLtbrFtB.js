import{g as w}from"./index-B8mIOO1f.js";function $(u,b){for(var i=0;i<b.length;i++){const l=b[i];if(typeof l!="string"&&!Array.isArray(l)){for(const p in l)if(p!=="default"&&!(p in u)){const r=Object.getOwnPropertyDescriptor(l,p);r&&Object.defineProperty(u,p,r.get?r:{enumerable:!0,get:()=>l[p]})}}}return Object.freeze(Object.defineProperty(u,Symbol.toStringTag,{value:"Module"}))}var k={exports:{}},A;function E(){return A||(A=1,function(u,b){ace.define("ace/ext/searchbox-css",["require","exports","module"],function(i,l,p){p.exports=`
