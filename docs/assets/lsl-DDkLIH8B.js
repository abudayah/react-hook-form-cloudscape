import{g as o}from"./index-zLmx0mYK.js";function $(l,i){for(var e=0;e<i.length;e++){const t=i[e];if(typeof t!="string"&&!Array.isArray(t)){for(const n in t)if(n!=="default"&&!(n in l)){const s=Object.getOwnPropertyDescriptor(t,n);s&&Object.defineProperty(l,n,s.get?s:{enumerable:!0,get:()=>t[n]})}}}return Object.freeze(Object.defineProperty(l,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}},p;function g(){return p||(p=1,function(l,i){ace.define("ace/snippets/lsl.snippets",["require","exports","module"],function(e,t,n){n.exports=`snippet @
	@\${1:label};
