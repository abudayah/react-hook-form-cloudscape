import{g as $}from"./index-zLmx0mYK.js";function o(s,p){for(var n=0;n<p.length;n++){const t=p[n];if(typeof t!="string"&&!Array.isArray(t)){for(const e in t)if(e!=="default"&&!(e in s)){const r=Object.getOwnPropertyDescriptor(t,e);r&&Object.defineProperty(s,e,r.get?r:{enumerable:!0,get:()=>t[e]})}}}return Object.freeze(Object.defineProperty(s,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},c;function u(){return c||(c=1,function(s,p){ace.define("ace/snippets/jsp.snippets",["require","exports","module"],function(n,t,e){e.exports=`snippet @page
