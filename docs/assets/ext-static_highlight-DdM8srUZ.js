import{g as D}from"./index-xh0nWSdw.js";function F(m,S){for(var a=0;a<S.length;a++){const u=S[a];if(typeof u!="string"&&!Array.isArray(u)){for(const l in u)if(l!=="default"&&!(l in m)){const v=Object.getOwnPropertyDescriptor(u,l);v&&Object.defineProperty(m,l,v.get?v:{enumerable:!0,get:()=>u[l]})}}}return Object.freeze(Object.defineProperty(m,Symbol.toStringTag,{value:"Module"}))}var b={exports:{}},E;function H(){return E||(E=1,function(m,S){ace.define("ace/ext/static-css",["require","exports","module"],function(a,u,l){l.exports=`.ace_static_highlight {
