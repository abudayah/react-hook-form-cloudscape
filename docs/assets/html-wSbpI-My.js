import{g as r}from"./index-xh0nWSdw.js";function o(p,i){for(var n=0;n<i.length;n++){const t=i[n];if(typeof t!="string"&&!Array.isArray(t)){for(const e in t)if(e!=="default"&&!(e in p)){const s=Object.getOwnPropertyDescriptor(t,e);s&&Object.defineProperty(p,e,s.get?s:{enumerable:!0,get:()=>t[e]})}}}return Object.freeze(Object.defineProperty(p,Symbol.toStringTag,{value:"Module"}))}var $={exports:{}},a;function d(){return a||(a=1,function(p,i){ace.define("ace/snippets/html.snippets",["require","exports","module"],function(n,t,e){e.exports=`# Some useful Unicode entities
# Non-Breaking Space
snippet nbs
	&nbsp;
# ←
