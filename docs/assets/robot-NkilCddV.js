import{g as c}from"./index-B8mIOO1f.js";function d(o,s){for(var t=0;t<s.length;t++){const e=s[t];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in o)){const i=Object.getOwnPropertyDescriptor(e,n);i&&Object.defineProperty(o,n,i.get?i:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}},p;function $(){return p||(p=1,function(o,s){ace.define("ace/snippets/robot.snippets",["require","exports","module"],function(t,e,n){n.exports=`# scope: robot
### Sections
