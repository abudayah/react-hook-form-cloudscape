import{g as a}from"./index-B8mIOO1f.js";function c($,p){for(var n=0;n<p.length;n++){const t=p[n];if(typeof t!="string"&&!Array.isArray(t)){for(const e in t)if(e!=="default"&&!(e in $)){const i=Object.getOwnPropertyDescriptor(t,e);i&&Object.defineProperty($,e,i.get?i:{enumerable:!0,get:()=>t[e]})}}}return Object.freeze(Object.defineProperty($,Symbol.toStringTag,{value:"Module"}))}var s={exports:{}},o;function u(){return o||(o=1,function($,p){ace.define("ace/snippets/php.snippets",["require","exports","module"],function(n,t,e){e.exports=`snippet ec
	echo \${1};
snippet ns
