import{g as l}from"./index-B8mIOO1f.js";function _(t,c){for(var a=0;a<c.length;a++){const e=c[a];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in t)){const r=Object.getOwnPropertyDescriptor(e,n);r&&Object.defineProperty(t,n,r.get?r:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}))}var m={exports:{}},o;function s(){return o||(o=1,function(t,c){ace.define("ace/theme/terminal-css",["require","exports","module"],function(a,e,n){n.exports=`.ace-terminal-theme .ace_gutter {
  background: #1a0005;
  color: steelblue
}
