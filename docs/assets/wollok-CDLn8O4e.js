import{g as a}from"./index-B8mIOO1f.js";function c(o,s){for(var t=0;t<s.length;t++){const n=s[t];if(typeof n!="string"&&!Array.isArray(n)){for(const e in n)if(e!=="default"&&!(e in o)){const p=Object.getOwnPropertyDescriptor(n,e);p&&Object.defineProperty(o,e,p.get?p:{enumerable:!0,get:()=>n[e]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var i={exports:{}},r;function u(){return r||(r=1,function(o,s){ace.define("ace/snippets/wollok.snippets",["require","exports","module"],function(t,n,e){e.exports=`##
